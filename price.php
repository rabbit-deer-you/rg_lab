<?php
	...
	mysql_query("insert into data values (".$act_id[0].",'',".$_GET['chifan'].",".$_GET['zhusu'].",".$_GET['jiaotong'].",".$_GET['menpiao'].",".$_GET['qita'].");");	
?>
<html>
<head>
...
<form action="">
	<textarea name="weibo" cols="20" rows="5" id="test2" style="overflow:visible"  >
		<?php echo trim($_GET['name'])." 活动，总参加人数为".$_GET['people']."人，每个人分担的费用为 
